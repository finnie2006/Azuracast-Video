...
def getapidata():
  long_song_name = subprocess.check_output('./usr/share/obs/obs-plugins/frontend-tools/scripts/get-song-name.sh').decode('utf-8')
  ...
  song_art = subprocess.check_output('./usr/share/obs/obs-plugins/frontend-tools/scripts/get-song-art.sh').decode('utf-8')
  art_data = obs.obs_data_create()
  obs.obs_data_set_string(art_data, "url", song_art)
  obs.obs_source_update(art_source, art_data)

  song_audio = subprocess.check_output('./usr/share/obs/obs-plugins/frontend-tools/scripts/get-song-audio.sh').decode('utf-8')
